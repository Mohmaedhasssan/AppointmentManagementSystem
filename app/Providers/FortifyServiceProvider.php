...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    private function captchaFails(Request $request): bool
    {
        if ($request->attributes->get('captcha_checked', false)) {
            return false;
        }

        $request->attributes->set('captcha_checked', true);
